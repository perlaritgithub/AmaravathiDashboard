...
export class HousesComponent implements OnInit {
  displayedColumns: string[] = ['ID','Date','District','Division','ColonyName','Department', 'HouseType','HouseNo','PlotNo','HouseImage','WorkStage','Latitude','Longitude'];
...
pdfMake(){
 ...
 gethousedata(){
  this.reportservice.gethousedata().subscribe(res => {
    this.Housedata = res.data;
    console.log(this.Housedata);
    this.dataSource = new MatTableDataSource(this.Housedata);
